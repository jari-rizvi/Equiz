...
@AndroidEntryPoint
class AllNotificationsFragment : BaseFragment<FragmentCanclledBinding, AllNotificaitonsViewModel>() {

    override val layoutId: Int
        get() = R.layout.fragment_canclled
    override val viewModel: Class<AllNotificaitonsViewModel>
        get() = AllNotificaitonsViewModel::class.java
