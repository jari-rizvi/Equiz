package com.teamx.equiz.ui.fragments.Auth.passchange
...
import com.teamx.equiz.databinding.FragmentChangePasswordBinding
import com.teamx.equiz.ui.fragments.Auth.createNewPass.CreateNewPassViewModel
...
@AndroidEntryPoint
class ChangePassFragment : BaseFragment<FragmentChangePasswordBinding, CreateNewPassViewModel>() {
    ...
    private fun initialization() {
        oldPassword = mViewDataBinding.etNewPass7.text.toString().trim()
...
//            params.addProperty("uniqueID", uniquId)
                ...
                Resource.Status.SUCCESS -> {
                    ...
                    it.data?.let { data ->
                        findNavController().navigate(
                            R.id.passChangeSuccessFragment,
                            arguments,
                            options
                        )
                    }
    ...
    fun validate(): Boolean {
        ...
        if (mViewDataBinding.etNewPass7.text.toString().trim().length < 8) {
            if (isAdded) {
