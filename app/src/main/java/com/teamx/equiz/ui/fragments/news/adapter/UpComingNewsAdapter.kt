...
class UpComingNewsAdapter(
    ...
    val onNewslistner: OnUpNewsListener
    ...
    override fun onBindViewHolder(
        holder: com.teamx.equiz.ui.fragments.news.NewsAdapter.NewsViewHolder,
        position: Int
    ) {
...
//        Picasso.get().load(news.image).resize(500,500).into(holder.binding.img)
        ...
        holder.itemView.setOnClickListener {
            onNewslistner.newsUpClick(position)
        }
...
interface OnUpNewsListener {
    fun newsUpClick(position: Int)
}